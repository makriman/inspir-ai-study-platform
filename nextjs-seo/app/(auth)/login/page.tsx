...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3000'}/api/auth/parent/login`, {
        method: 'POST',
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-inspir-purple focus:ring-inspir-purple border-gray-300 rounded"
                />
              ...
              <div className="text-sm">
                <Link href="/reset-password" className="font-semibold text-inspir-purple hover:text-inspir-blue">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link href="/signup" className="font-semibold text-inspir-purple hover:text-inspir-blue">
                Start free trial
              </Link>
            </p>
          </div>
