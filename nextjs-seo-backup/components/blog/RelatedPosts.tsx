      ...
      <div className="grid md:grid-cols-3 gap-6">
        {posts.map((post) => (
          <Link
            key={post.id}
            href={`/blog/${post.slug}`}
            className="group bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all hover:scale-105 border-2 border-gray-200 hover:border-inspir-purple"
          >
            <span
            ...
            <h3 className="text-xl font-bold mb-3 group-hover:text-inspir-purple transition-colors line-clamp-2">
              {post.title}
            </h3>
